...
const Testimonials = () => {
    ...
    return (
        <section className='testimonials bg-mainColor-100' id='reviews'>
            <div className='container mx-auto text-center' data-aos='fade-right'>
                ...
                <div className={`${displayCard==='1'?'card':'hidden'}`}>
                    ...
                    <p className='w-1/2 mx-auto text-slate-500 my-4 text-lg'>"Far far Away,behind the world mountains, far from the countries Vokalia and Consnantia,there live the blind texts, Separated they live far from Countries Vokalia."</p>
